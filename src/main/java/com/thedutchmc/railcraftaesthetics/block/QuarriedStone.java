...
public class QuarriedStone extends Block {
	...
	public QuarriedStone(String name, Material materialIn) {
    ...
    public void registerItemModel() {
    	...
    	railcraftaesthetics.proxy.registerItemRenderer(Item.getItemFromBlock(this), 0, "quarried_stone");
