...
public class InvarBlock extends Block {
	...
	public InvarBlock(String name, Material materialIn) {
    ...
    public void registerItemModel() {
    	...
    	railcraftaesthetics.proxy.registerItemRenderer(Item.getItemFromBlock(this), 0, "invar_block");
